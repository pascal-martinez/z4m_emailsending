...
// Email subject
$this->templateSubject = '[[**application_name**]]: nueva cuenta de usuario';

// Email message body
$this->templateBody = <<<'EOT'
<div style="font-family:Arial,Helvetica,sans-serif;font-size:14px;">
<p>Hola [[user_name]],</p>
<p>Una nueva cuenta de usuario ha sido creada para usted.<br>
Aquí esta sus identificadores para conectarse a la aplicación <b>[[**application_name**]]</b> desde su navegador web:</p>
<ul>
